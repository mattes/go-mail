...
func init() {
	...
	file3 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1573551809, 0),

		Content: string("Subject: \"damn1\"\n\nPreheader: \"\"\n\nName: \"Mattes\"\n\nBody: |\n  # Hi Matthias\n  I can _say_ something here!\n\n  * Do this now\n  * and this\n\nFooter: |\n  The footer!\n\nCallToAction: \"Get free beer now!\"\nCallToActionURL: \"https://www.youtube.com/results?search_query=how+to+get+free+beer\"\n\nOrgAddress: \"1460 Mission Street, San Francisco, CA 94105\"\n"),
	}
	file4 := &embedded.EmbeddedFile{
		Filename:    "simple.html",
		FileModTime: time.Unix(1573551775, 0),
